...
export { SET_NAME, SET_EMAIL, SET_PASSWORD, SET_CONFIRM_PASSWORD, SET_SELECTED_QUESTION, SET_ANSWER, SET_EMAIL_ERROR, SET_PASSWORD_ERROR, SET_CONFIRM_PASSWORD_ERROR, RESET_STATE }
